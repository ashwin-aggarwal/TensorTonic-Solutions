...
def scaled_dot_product_attention(Q: torch.Tensor, K: torch.Tensor, V: torch.Tensor) -> torch.Tensor:
    ...
    *batch, n_v, d_v = V.shape
    #the last two dimensions give sequence_length and dimensionality
    #the rest of it is just feature information which is getting multiplied
    ...
    # last dimnesion gives the weights for embeddings
